...
class Markermaker {
  Future<BitmapDescriptor> make(BuildContext context,String i) async {
    ...
    final ui.Image image = await recorder.endRecording().toImage(pixel.toInt(), (pictureInfo.size.height*pixel).toInt());
  ...
  Future<Map<String,BitmapDescriptor>> loadicons(BuildContext context) async{
    ...
    List<String> paths = [ "1","AIR","AM","Bike","BL","BR","Bus","C","G","K","O1","O2","R1","R2","V","Y"];
